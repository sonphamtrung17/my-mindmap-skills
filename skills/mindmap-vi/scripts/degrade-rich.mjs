...
// Skills are installed as a symlink (~/.agents/skills/<name> -> this repo), so
// this script is invoked by a symlinked path while Node resolves
// import.meta.url to the realpath. Compare realpaths, or the CLI silently does
// nothing and the poster path keeps the undegraded rich nodes.
